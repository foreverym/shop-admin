...
public class DaoException extends Exception
{
     ...
     */
    public static final DaoException DAO_INSERT_RESULT_0 = new DaoException(
            ExceptionConstants.DAO_INSERT_RESULT_0,
            "database operation,insert result  0");

    /**
     * database operation,update result 0
     */
    public static final DaoException DAO_UPDATE_RESULT_0 = new DaoException(
            ExceptionConstants.DAO_UPDATE_RESULT_0,
            "database operation,update result  0");

    /**
     * database operation,delete result 0
     */
    public static final DaoException DAO_DELETE_RESULT_0 = new DaoException(
            ExceptionConstants.DAO_DELETE_RESULT_0,
            "database operation,delete result  0");

    /**
     * database operation,selectOne result null
     */
    public static final DaoException DAO_SELECTONE_IS_NULL = new DaoException(
            ExceptionConstants.DAO_SELECTONE_IS_NULL,
            "database operation,selectOne result  null");

    /**
     * database operation,list result null
     */
    public static final DaoException DAO_LIST_IS_NULL = new DaoException(
            ExceptionConstants.DAO_LIST_IS_NULL,
            "database operation,list result  null");
